...
Download the first release of the "Dubit Platform Editor":http://dubitplatform.com/platform-beta and for fellow code monkeys this very git hub repository has a template virtual world for dirtying your hands.

h2. Supported Features

The Lite version of the Platform supports the following core features. Full platform installation includes Admin website, shops, payment gateway integration, customizable avatars, persistence, and more.
